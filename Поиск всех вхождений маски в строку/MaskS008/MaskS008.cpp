#include <iostream> // программа, которая ищет в строке все вхождения задаваемой маски. Выдает список номеров символов, на которых найдено совпадение или -1 если совпадений не найдено.
