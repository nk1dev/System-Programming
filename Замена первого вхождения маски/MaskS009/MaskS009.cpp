#include <iostream> //  программа, которая ищет в строке первое вхождение задаваемой маски и заменяет на заданную строку замены. Выдает номер символа, начиная с которого была сделана замена или -1 если замен не было.
